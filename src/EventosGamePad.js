...
function actualizarOrdenes(){
    ...
    if ( gP1.buttons[2].pressed){ // 0 es el botón X
    ...
    if ( gP1.buttons[3].pressed){ // 2 es el botón A
        if ( botonesPulsados[3] == false ) {
            botonesPulsados[3] = true
            controles.disparo = true;
            controles.continuar = true;
        }
    } else {
        botonesPulsados[3] = false
